...
print("*************************************************************************")
hash_dict = {'name':'yokesh','age':22,'fav_language':'python','fav_dish':'biryani'}

print('hash_dict before updating is :',hash_dict)
hash_dict_keys1 = hash_dict.keys()
hash_dict_values1 = hash_dict.values()
hash_dict_items1 = hash_dict.items()
print(hash_dict_keys1,hash_dict_values1,hash_dict_items1)

hash_dict['fav_fruit'] = 'mango'

print('hash_dict after updating is :',hash_dict)
# After updating dict() with new item, there is no need to derive keys,items and values again from the dictionary
# and to store in 3 variables again, we can use line 6 ,the newly added item is auto updated to hash_dict_keys1,
# hash_dict_values1 and hash_dict_items1 implicitly.


print(hash_dict_keys1,hash_dict_values1,hash_dict_items1)

# If we store keys() of a dictionary in 2 or more different variables-
# -those variables will store in different memory locations only.
# That's why the below code in lines 29,30,31 returns False, even though lines 26,27,28 store same items-
# -as the lines 6,7,8, but at different memory locations.

hash_dict_keys2 = hash_dict.keys()
hash_dict_values2 = hash_dict.values()
hash_dict_items2 = hash_dict.items()

print(hash_dict_keys1 is hash_dict_keys2)
print(hash_dict_values1 is hash_dict_values2)
print(hash_dict_items1 is hash_dict_items2)
