...
print(0//21)
print(-0//12)
print(3//10) # 0 as 0.3 rounded to 0
print("***********************************")
...
print("bit at 1st position in 1011 is :",get_bit_at_specified_position(1011,1))   # 1
print("bit at 2nd position in 100101 is :",get_bit_at_specified_position(100101,2)) # 1
print("bit at 3rd position in 1011 is :",get_bit_at_specified_position(1011,3)) # 0
